INSERT INTO `PRJ_PROJECT` (`PRNO`, `PRSTARTDATE`, `PRENDDATE`, `PRTITLE`, `PRDATE`, `USERNO`, `PRSTATUS`, `DELETEFLAG`) VALUES
	(1, '2016-11-27', '2017-03-03', '시연 전자 과제 관리 시스템 구축', NOW(), 1, '0', 'N');

INSERT INTO `PRJ_TASK` (`PRNO`, `TSNO`, `TSPARENT`, `TSSORT`, `TSTITLE`, `TSSTARTDATE`, `TSENDDATE`, `TSENDREAL`, `TSRATE`, `DELETEFLAG`) VALUES
	(1, 1, NULL, NULL, '분석/설계', '', '', '', 0, 'N'),
	(1, 2, 1, NULL, '시스템 분석', '2016-12-01', '2016-12-16', '', 0, 'N'),
	(1, 3, 1, NULL, '업무 분석', '2016-12-01', '2016-12-16', '', 0, 'N'),
	(1, 4, 1, NULL, '화면구성', '2016-12-19', '2016-12-30', '', 0, 'N'),
	(1, 5, 1, NULL, 'DB설계', '2016-12-19', '2016-12-30', '', 0, 'N'),
	(1, 6, NULL, NULL, '구현', '', '', '', 0, 'N'),
	(1, 7, 6, NULL, '사용자 화면 개발', '2017-01-02', '2017-02-10', '', 0, 'N'),
	(1, 8, 6, NULL, '관리자 화면 개발', '2017-01-16', '2017-02-28', '', 0, 'N'),
	(1, 9, NULL, NULL, '테스트', '', '', '', 0, 'N'),
	(1, 10, 9, NULL, '단위 테스트', '2017-02-20', '2017-02-28', '', 0, 'N'),
	(1, 11, 9, NULL, '통합 테스트', '2017-02-27', '2017-03-03', '', 0, 'N'),
	(1, 12, NULL, NULL, '이행', '', '', '', 0, 'N'),
	(1, 13, 12, NULL, '운영서버 설치', '2017-03-01', '2017-03-03', '', 0, 'N'),
	(1, 14, 12, NULL, '오픈', '2017-03-06', '2017-03-06', '', 0, 'N');
